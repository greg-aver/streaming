...
class VADWorker(IWorker):
    ...
    def __init__(
        ...
        Senior approach: Получаем все зависимости через конструктор
        ...
        # Event bus будет установлен через set_event_bus() 
        # Senior pattern: разделяем создание объекта и его конфигурацию
